...
Updated: 2026-06-26 — **Stage 1 friction telemetry running** (clock started 2026-06-15T20:14:07Z; **~day 11 — window closes ~2026-06-29**, decision point imminent). #238 applied + verified + closed. **Live arc: onboarding-baseline self-consistency** (new section below) — PR [#284](https://github.com/ArchonVII/archon-setup/pull/284) green, owner-merge pending. Merged since the 2026-06-21 map: #252 ([PR #276](https://github.com/ArchonVII/archon-setup/pull/276)), #153 ([PR #274](https://github.com/ArchonVII/archon-setup/pull/274)), #272 ([PR #277](https://github.com/ArchonVII/archon-setup/pull/277)). Housekeeping: 9 merged-PR remote branches pruned.
...
## Onboarding-baseline self-consistency — live arc (since 2026-06-23)

Make existing-repo onboarding produce a baseline that passes its **own** required gate. Active hardening lane and the hard prereq for the first real consumer onboarding.

- **PR [#284](https://github.com/ArchonVII/archon-setup/pull/284)** — _a freshly onboarded repo satisfies its own baseline_ (fixes [#278](https://github.com/ArchonVII/archon-setup/issues/278), [#280](https://github.com/ArchonVII/archon-setup/issues/280), [#281](https://github.com/ArchonVII/archon-setup/issues/281), [#282](https://github.com/ArchonVII/archon-setup/issues/282)): invalid `stack: minimal`, GHAS `dependency-review` assumed-on, baseline internal-consistency, dangling `docs/agent-process/message-protocol.md` link. **Green CI; `MERGEABLE` but `BLOCKED` on conversation-resolution + owner merge.**
- **PR [#279](https://github.com/ArchonVII/archon-setup/pull/279)** — wire doc-health + repo-update-log README into onboarding. **PR [#273](https://github.com/ArchonVII/archon-setup/pull/273)** ([#253](https://github.com/ArchonVII/archon-setup/issues/253)) — ignore the close-scan marker dir on onboarding.
- Spun off #284: [#286](https://github.com/ArchonVII/archon-setup/issues/286) (close-scan `hasNpmScript` skips node-test green on malformed `package.json`), [#283](https://github.com/ArchonVII/archon-setup/issues/283) (preflight origin-detection not hermetic).
- **First consumer onboarding — civ-sim:** `C:\josephaguirre\civ-sim` (origin ArchonVII/civ-sim) audited 2026-06-26 = 1 present / 43 missing / 1 drifted (greenfield). **Queued behind #284** (owner decision 2026-06-26: wait for #284, then dispatch a coding agent in an isolated worktree). Plan: `C:\Users\josep\.claude\plans\civ-sim-onboarding-plan.md`.

## Open PRs (OS layer)

- **Triage-fix dispatch (2026-06-21 AI-discovered sweep) — landing:** #252 → [PR #276](https://github.com/ArchonVII/archon-setup/pull/276) **MERGED**, #153 → [PR #274](https://github.com/ArchonVII/archon-setup/pull/274) **MERGED**; #253 → [PR #273](https://github.com/ArchonVII/archon-setup/pull/273) **OPEN** (folded into the onboarding-baseline arc above); [github-workflows#89](https://github.com/ArchonVII/github-workflows/issues/89) (`*.mjs eol=lf`) + [repo-template#104](https://github.com/ArchonVII/repo-template/issues/104) (cygpath bash-path) remain open. Dossier: `docs/../_analysis/ai-discovered-triage-2026-06-21.md` (workbench).
