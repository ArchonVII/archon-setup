...
| [ArchonVII/repo-template](https://github.com/ArchonVII/repo-template) | `C:/GitHub/repo-template` | baseline-provider | AGENTS.md (canonical per-repo contract); .agent/ startup + check-map baseline; scripts/agent/ lifecycle helpers; scripts/doc-sweep/ | snapshot main@4ddf930 |
...
_Provider snapshots captured 2026-06-21T17:46:31.232Z … 2026-06-29T23:43:00.757Z (source: `src/snapshots/manifest.json`)._
