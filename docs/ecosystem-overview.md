...
| [ArchonVII/github-workflows](https://github.com/ArchonVII/github-workflows) | `C:/GitHub/github-workflows` | workflow-provider | reusable workflow bodies (examples/*.yml); scripts/setup-repo.mjs (labels + branch protection) | consumed @v1; snapshot v1@62d3f86 |
...
_Provider snapshots captured 2026-06-09T22:47:14.128Z … 2026-06-09T22:47:14.219Z (source: `src/snapshots/manifest.json`)._
