...
| [ArchonVII/repo-template](https://github.com/ArchonVII/repo-template) | `C:/GitHub/repo-template` | baseline-provider | AGENTS.md (canonical per-repo contract); .agent/ startup + check-map baseline; scripts/agent/ lifecycle helpers; scripts/doc-sweep/ | snapshot main@dc20329 |
...
_Provider snapshots captured 2026-07-15T23:35:33.622Z … 2026-07-15T23:35:33.949Z (source: `src/snapshots/manifest.json`)._
