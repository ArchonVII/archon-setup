...
| [ArchonVII/github-workflows](https://github.com/ArchonVII/github-workflows) | `C:/GitHub/github-workflows` | workflow-provider | reusable workflow bodies (examples/*.yml); scripts/setup-repo.mjs (labels + branch protection) | consumed @v1; snapshot v1@dc64da5 |
...
_Provider snapshots captured 2026-06-09T22:26:16.999Z … 2026-06-09T22:26:17.108Z (source: `src/snapshots/manifest.json`)._
