...
| [ArchonVII/repo-template](https://github.com/ArchonVII/repo-template) | `C:/GitHub/repo-template` | baseline-provider | AGENTS.md (canonical per-repo contract); .agent/ startup + check-map baseline; scripts/agent/ lifecycle helpers; scripts/doc-sweep/ | snapshot main@5540747 |
...
_Provider snapshots captured 2026-06-09T23:23:41.508Z … 2026-06-09T23:23:41.592Z (source: `src/snapshots/manifest.json`)._
