...
| [ArchonVII/repo-template](https://github.com/ArchonVII/repo-template) | `C:/GitHub/repo-template` | baseline-provider | AGENTS.md (canonical per-repo contract); .agent/ startup + check-map baseline; scripts/agent/ lifecycle helpers; scripts/doc-sweep/ | snapshot main@58aa9b8 |
...
_Provider snapshots captured 2026-07-02T04:15:48.504Z … 2026-07-02T17:01:14.174Z (source: `src/snapshots/manifest.json`)._
