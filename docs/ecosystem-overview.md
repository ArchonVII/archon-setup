...
| [ArchonVII/repo-template](https://github.com/ArchonVII/repo-template) | `C:/GitHub/repo-template` | baseline-provider | AGENTS.md (canonical per-repo contract); .agent/ startup + check-map baseline; scripts/agent/ lifecycle helpers; scripts/doc-sweep/ | snapshot main@98a08fa |
...
_Provider snapshots captured 2026-06-16T02:58:39.391Z … 2026-06-21T01:03:35.204Z (source: `src/snapshots/manifest.json`)._
