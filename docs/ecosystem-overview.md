...
| --- | --- | --- | --- | --- |
| [ArchonVII/.github](https://github.com/ArchonVII/.github) | `C:/GitHub/.github` | org-defaults-provider | issue templates; pull request templates; SECURITY.md; release.yml; STARTER.md doc-policy guide | snapshot main@3187457 |
| [ArchonVII/github-workflows](https://github.com/ArchonVII/github-workflows) | `C:/GitHub/github-workflows` | workflow-provider | reusable workflow bodies (examples/*.yml); scripts/setup-repo.mjs (labels + branch protection) | consumed @v1; snapshot v1@ae00ba3 |
| [ArchonVII/repo-template](https://github.com/ArchonVII/repo-template) | `C:/GitHub/repo-template` | baseline-provider | AGENTS.md (canonical per-repo contract); .agent/ startup + check-map baseline; scripts/agent/ lifecycle helpers; scripts/doc-sweep/ | snapshot main@6d64ca2 |
...
_Provider snapshots captured 2026-06-12T21:46:17.423Z … 2026-06-14T03:51:44.016Z (source: `src/snapshots/manifest.json`)._
