...
| [ArchonVII/repo-template](https://github.com/ArchonVII/repo-template) | `C:/GitHub/repo-template` | baseline-provider | AGENTS.md (canonical per-repo contract); .agent/ startup + check-map baseline; scripts/agent/ lifecycle helpers; scripts/doc-sweep/ | snapshot main@7853175 |
...
_Provider snapshots captured 2026-06-12T21:46:17.423Z … 2026-06-12T21:46:17.535Z (source: `src/snapshots/manifest.json`)._
