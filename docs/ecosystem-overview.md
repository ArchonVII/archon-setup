...
| [ArchonVII/repo-template](https://github.com/ArchonVII/repo-template) | `C:/GitHub/repo-template` | baseline-provider | AGENTS.md (canonical per-repo contract); .agent/ startup + check-map baseline; scripts/agent/ lifecycle helpers; scripts/doc-sweep/ | snapshot main@efeba25 |
...
_Provider snapshots captured 2026-07-17T05:08:36.637Z … 2026-07-20T20:47:27.021Z (source: `src/snapshots/manifest.json`)._
