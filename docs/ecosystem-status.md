...
_Last updated: 2026-06-13 by Codex (housekeeping status refresh #242)_
...
| Repo               | Status        | Detail                                                                                                                                         |
| ------------------ | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `archon-setup`     | In progress   | Ecosystem registry/dashboard epic [#212](https://github.com/ArchonVII/archon-setup/issues/212): lanes 0-2 merged on 2026-06-12 (`3fe47b0`, `4d00804`, `f67a081`); lanes 3-9 remain mapped in [`docs/CURRENT_WORK.md`](./CURRENT_WORK.md). Document-policy spec PR [#224](https://github.com/ArchonVII/archon-setup/pull/224) merged on 2026-06-12, so epic [#223](https://github.com/ArchonVII/archon-setup/issues/223) implementation lanes are no longer owner-held by the spec gate. Agent OS epic [#229](https://github.com/ArchonVII/archon-setup/issues/229) Stage 0 snapshot refresh [#237](https://github.com/ArchonVII/archon-setup/pull/237) merged; Stage 1 friction PRs [#240](https://github.com/ArchonVII/archon-setup/pull/240) and [#241](https://github.com/ArchonVII/archon-setup/pull/241) are open with visible CI green but GitHub merge state blocked. |
| `repo-template`    | In progress   | OS Stage 0/1 provider batch merged on 2026-06-12: [#75](https://github.com/ArchonVII/repo-template/issues/75)/PR [#80](https://github.com/ArchonVII/repo-template/pull/80), [#76](https://github.com/ArchonVII/repo-template/issues/76)/PR [#79](https://github.com/ArchonVII/repo-template/pull/79), [#77](https://github.com/ArchonVII/repo-template/issues/77)/PR [#81](https://github.com/ArchonVII/repo-template/pull/81), [#28](https://github.com/ArchonVII/repo-template/issues/28)/PR [#82](https://github.com/ArchonVII/repo-template/pull/82), and [#78](https://github.com/ArchonVII/repo-template/issues/78)/PR [#83](https://github.com/ArchonVII/repo-template/pull/83). Epic #212 lanes [#70](https://github.com/ArchonVII/repo-template/issues/70) and [#71](https://github.com/ArchonVII/repo-template/issues/71) remain open; document-policy lanes [#72](https://github.com/ArchonVII/repo-template/issues/72), [#73](https://github.com/ArchonVII/repo-template/issues/73), and [#74](https://github.com/ArchonVII/repo-template/issues/74) are now unblocked by the merged archon-setup spec. |
| `github-workflows` | In progress   | README refresh PR [#66](https://github.com/ArchonVII/github-workflows/pull/66) merged on 2026-06-12. Dependabot actions PR [#68](https://github.com/ArchonVII/github-workflows/pull/68) remains open with `vitest` failing. Document-policy lanes [#69](https://github.com/ArchonVII/github-workflows/issues/69) and [#70](https://github.com/ArchonVII/github-workflows/issues/70) remain blocked by repo-template document-policy prerequisites. `@v1` retag remains owner-gated. |
| `.github`          | In progress   | Profile refresh PR [#29](https://github.com/ArchonVII/.github/pull/29) merged on 2026-06-12. Document-policy STARTER lane [#27](https://github.com/ArchonVII/.github/issues/27) remains open and is now unblocked by the merged archon-setup spec. |
| `jma-skill-review` | In progress   | Description lint gate PR [#180](https://github.com/ArchonVII/jma-skill-review/pull/180) remains open with its visible check green. Dependabot PR [#187](https://github.com/ArchonVII/jma-skill-review/pull/187) is also open. PRs [#183](https://github.com/ArchonVII/jma-skill-review/pull/183) and [#184](https://github.com/ArchonVII/jma-skill-review/pull/184) merged on 2026-06-12. Project-intake skill lane [#178](https://github.com/ArchonVII/jma-skill-review/issues/178) waits for repo-template vision/doc-policy lanes. |

## In-flight PRs

| Repo | PR | Purpose / state |
| --- | --- | --- |
| `archon-setup` | [#240](https://github.com/ArchonVII/archon-setup/pull/240) | Friction ledger collector; visible CI green, but GitHub reports `mergeStateStatus=BLOCKED`. |
| `archon-setup` | [#241](https://github.com/ArchonVII/archon-setup/pull/241) | Friction-ledger registry feature; visible CI green, but GitHub reports `mergeStateStatus=BLOCKED`. |
...
| `jma-skill-review` | [#180](https://github.com/ArchonVII/jma-skill-review/pull/180) | Description lint gate; visible check green. |
| `jma-skill-review` | [#187](https://github.com/ArchonVII/jma-skill-review/pull/187) | Dependabot esbuild patch bump in `/.hub`; open. |

## F-roadmap

Feature IDs come from the `docs/phase2/findings.md` numbering. Severity reflects the original finding.

Review note, 2026-06-13: the rows below were reconciled against GitHub issue state during #242. Current execution focus is the Agent OS roadmap (#229), document-policy epic (#223), and the registry/dashboard epic (#212); update the rows below only when a tracked F-number issue changes state.
...
| F4  | Format-on-edit authority duplication           | **Closed**                                             | medium   | `.github` #11                                          |
| F5  | Demote lint-on-edit to advisory                | **Closed**                                             | medium   | `.github` #12                                          |
| F6  | Close-scan marker semantics                    | **Closed**                                             | medium   | `.github` #13                                          |
| F7  | Agent role separation / Owner Maintenance Lane | **Closed across tracked issues**                       | high     | `.github` #14; github-workflows #26; repo-template #21 |
| F8  | Worktree-per-task discipline                   | **Closed**                                             | medium   | `.github` #15                                          |
...
| F11 | Release-Admiral "finish it" merge contract     | **Closed**                                             | medium   | `.github` #16                                          |
| F13 | `.agent/check-map.yml` + recommender           | **Closed**                                             | medium   | repo-template #12                                      |
...
| F16 | Per-PR durable history records                 | **Closed**                                             | low      | `.github` #17                                          |
| F18 | `.githooks/` baseline                          | **Shipped**                                            | —        | repo-template #16/#18                                  |
| F19 | Issue-Admiral triage role                      | **Closed**                                             | low      | `.github` #18                                          |

## Backlog (prioritized)

1. **Unblock friction telemetry PRs [#240](https://github.com/ArchonVII/archon-setup/pull/240) and [#241](https://github.com/ArchonVII/archon-setup/pull/241)** — visible CI is green, but GitHub reports both merge states blocked.
2. **Fix `github-workflows` PR [#68](https://github.com/ArchonVII/github-workflows/pull/68)** — `vitest` is failing, and this is the remaining open workflow-provider PR.
3. **Start the unblocked document-policy provider lanes** — `.github` [#27](https://github.com/ArchonVII/.github/issues/27) and repo-template [#72](https://github.com/ArchonVII/repo-template/issues/72) are the first dependencies after archon-setup spec PR #224 merged.
4. **Advance archon-setup epic #212 lanes 3 and 4** — registry CRUD/RPC [#216](https://github.com/ArchonVII/archon-setup/issues/216) and the React shell [#217](https://github.com/ArchonVII/archon-setup/issues/217) can proceed in parallel after the current friction PR block is understood.
5. **Address F15 actions hardening** — github-workflows [#14](https://github.com/ArchonVII/github-workflows/issues/14) remains the open F-roadmap item after the closed-issue reconciliation.

## Recently completed

- **2026-06-13** — Housekeeping merged `archon-setup` PRs [#208](https://github.com/ArchonVII/archon-setup/pull/208) and [#209](https://github.com/ArchonVII/archon-setup/pull/209), fast-forwarded local `main` to `782ee7b`, and pruned the merged #208 worktree.
- **2026-06-12** — Agent OS Stage 0/1 repo-template provider batch was snapshotted by `archon-setup` PR [#237](https://github.com/ArchonVII/archon-setup/pull/237), closing [#232](https://github.com/ArchonVII/archon-setup/issues/232): anomaly triage caller (`repo-template` PR [#80](https://github.com/ArchonVII/repo-template/pull/80)), doc-orphan detector wiring (PR [#79](https://github.com/ArchonVII/repo-template/pull/79)), default-branch hook repair (PR [#81](https://github.com/ArchonVII/repo-template/pull/81)), local close-scan guard (PR [#82](https://github.com/ArchonVII/repo-template/pull/82)), and friction ledger contract (PR [#83](https://github.com/ArchonVII/repo-template/pull/83)).
- **2026-06-12** — Document-policy spec PR [#224](https://github.com/ArchonVII/archon-setup/pull/224), `github-workflows` README refresh PR [#66](https://github.com/ArchonVII/github-workflows/pull/66), and `.github` profile refresh PR [#29](https://github.com/ArchonVII/.github/pull/29) merged.
