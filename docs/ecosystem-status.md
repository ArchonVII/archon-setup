...
_Last updated: 2026-06-09 by Codex (required-gate label-trigger #168 lane)_
...
| Repo               | Status        | Detail                                                                                                                                         |
| ------------------ | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `github-workflows` | Clean on main | `v1` moved to `dc64da5` on 2026-06-09 (#58), removing broad required-gate label triggers after the Go lane release. No open PRs.                |
| `archon-setup`     | In progress   | #168 refreshes the required-gate snapshot to `dc64da5`; #145 PR1 merged (#146). E2E roadmap filed: umbrella #154, milestones #155–#165. Next: `distribute` subcommand (#155 = #145 PR2). |
