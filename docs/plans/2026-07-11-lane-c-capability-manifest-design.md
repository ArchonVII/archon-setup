...
> **Status:** APPROVED (owner, 2026-07-11) — decisions: 3 tiers (docs-min / agent-standard / flagship); manifest extends features.json; caveat-line narrative fix; new epic + C1–C6 children. Implementation not started.
> **Date:** 2026-07-11
