...
- **Changed paths:** scripts/refresh-snapshots.mjs, test/refreshSnapshots.test.mjs, src/snapshots/repo-template/**, src/snapshots/manifest.json, docs/ecosystem-overview.md, .changelog/unreleased/255-provider-scoped-refresh.md, docs/repo-update-log.md
