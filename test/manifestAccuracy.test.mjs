...
test("tasks do not record existing files as created during apply", async () => {
  const cases = [
    ...
    { name: "writeGitignore", task: writeGitignore, files: [".gitignore"], fetch: true },
    {
      name: "writeAgentsMd",
      task: writeAgentsMd,
      files: ["AGENTS.md", "docs/repo-update-log.md", "docs/repo-update-log/README.md", ".agent/startup-baseline.json", "docs/plans/README.md", "docs/agent-process/document-policy.md"],
    },
